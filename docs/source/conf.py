...
# comorbidade_covid documentation build
...
from comorbidade_covid import __version__ as release

# -- Project information -----------------------------------------------------

project = "comorbidade_covid"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "comorbidade_coviddoc"
...
latex_documents = [
    (
        master_doc,
        "comorbidade_covid.tex",
        "comorbidade_covid Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "comorbidade_covid",
        "Project comorbidade_covid codebase.",
        "Data-Science",
    )
]
